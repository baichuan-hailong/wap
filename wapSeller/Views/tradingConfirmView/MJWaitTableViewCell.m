...
@implementation MJWaitTableViewCell
...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        [MJLabelManager setLabel:self.stateLabel
                            text:@"--"
                       textColor:[UIColor colorWithHex:@"ff571d"]
                   textAlignment:NSTextAlignmentCenter
                            font:[UIFont systemFontOfSize:em*38]
                     borderColor:[UIColor colorWithHex:@"ffa687"]
                     borderWidth:1
                          radius:3];
        ...
        [MJBtnManager setButton:self.sureBtn
                           text:@"确认"
                      textColor:[UIColor colorWithHex:@"fff2f2"]
                           font:[UIFont systemFontOfSize:em*42]
                          image:[UIImage imageWithColor:[UIColor colorWithHex:@"f91e1e"]]
                         radius:4];
        ...
        [MJBtnManager setButton:self.cancleBtn
                      ...
                      textColor:[UIColor colorWithHex:@"f91e1e"]
                           font:[UIFont systemFontOfSize:em*42]
                    borderColor:[UIColor colorWithHex:@"f91e1e"]
                    borderWidth:1
                         radius:4];
        [self.cancleBtn setBackgroundImage:[UIImage imageWithColor:[UIColor whiteColor]] forState:UIControlStateNormal];
...
- (void)setWait:(NSDictionary *)waitDic{
    ...
    if (waitDic!=nil) {
        ...
        NSString *orderRebatePrices = [NSString stringWithFormat:@"%@",waitDic[@"orderRebatePrices"]];//orderRebatePrices
        self.crashBackLabel.text = [NSString stringWithFormat:@"%.2f元",[orderRebatePrices floatValue]];
        
        //卖家扣款
        self.seller_deducTipLabel.text = @"卖家扣款";
        NSString *financialReceive = [NSString stringWithFormat:@"%@",waitDic[@"shopReceive"]];//financialReceive
...
- (UILabel *)stateLabel{
    if (_stateLabel==nil) {
        _stateLabel = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-em*35-em*135, em*64, em*135, em*54)];
    }
    return _stateLabel;
}
...
- (UIButton *)sureBtn{
    if (_sureBtn==nil) {
        _sureBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-em*35-em*286, em*757, em*286, em*100)];
    }
    return _sureBtn;
}
...
- (UIButton *)cancleBtn{
    if (_cancleBtn==nil) {
        _cancleBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-em*35-em*286-em*53-em*286, em*757, em*286, em*100)];
    }
    return _cancleBtn;
}
